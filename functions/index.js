...
var gcconfig = {
    projectId: "wg-food",
    keyFilename: "wg-food-firebase-adminsdk-k8n4t-b01aa600ae.json"
  };
...
admin.initializeApp({
 ...
 exports.storeRecipes = functions.https.onRequest(function(request, response) {
    cors(request, response, function() {
      ...
      busboy.on("finish", () => {
        var bucket = gcs.bucket("wg-food.appspot.com");
        bucket.upload(
          upload.file,
          {
            uploadType: "media",
